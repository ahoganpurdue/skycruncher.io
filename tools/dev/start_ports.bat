...
start "SkyCruncher Desktop 3005" /min /d "k:\Coding Projects\Newtonian Color Engine\ASTROLOGIC_DEPLOY" cmd /c "npx vite --port 3005 --strictPort --host 127.0.0.1"
start "SkyCruncher Overnight 5603" /min /d "k:\Coding Projects\Newtonian Color Engine\ASTROLOGIC_DEPLOY" cmd /c "npx vite --port 5603 --strictPort --host 127.0.0.1"
