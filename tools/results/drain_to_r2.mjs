...
const ENV_FILE = opt('env', 'K:/Coding Projects/Newtonian Color Engine/ASTROLOGIC_DEPLOY/src/engine/ui/dashboard/.env.r2');
...
const DEFAULT_ROOTS = [
  ...
  ['Kmain', 'K:/Coding Projects/Newtonian Color Engine/ASTROLOGIC_DEPLOY/test_results'],
  ['Krest', 'K:/Coding Projects/Newtonian Color Engine/rest-integration/test_results'],
