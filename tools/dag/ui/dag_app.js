...
function renderPanel() {
  ...
  if (sel.type === 'node') {
    ...
    body.innerHTML = `
      ...
      <div class="p-sec"><button class="btn human" id="draw-btn">draw edge from here…</button>
    ...
    body.querySelector('#draw-btn').addEventListener('click', () => { state.drawFrom = n.id; renderPanel(); });
