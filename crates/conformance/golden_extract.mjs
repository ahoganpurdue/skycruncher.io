...
const DEPLOY_PKG = path.join(REPO_ROOT, 'package.json');
// rest-integration is a sibling checkout; override via SKYCRUNCHER_REST_CHECKOUT
const REST = process.env.SKYCRUNCHER_REST_CHECKOUT || path.resolve(REPO_ROOT, '../rest-integration');
