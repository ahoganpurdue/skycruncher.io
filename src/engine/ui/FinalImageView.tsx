...
export const FinalImageView: React.FC<FinalImageViewProps> = ({ session, registerCanvas }) => {
    ...
    return (
        ...
        >
            ...
            {/* HONEST RENDER-PLANE LABEL (LAW 3). */}
            <div className="absolute bottom-3 left-3 max-w-[72%] bg-space-900/75 backdrop-blur-md border border-line rounded px-2.5 py-1.5">
