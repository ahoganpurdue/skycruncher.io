    ...
    >
      ...
      />
        ...
        <label htmlFor="astro-file-input" className="upload-label">
          ...
          <div className="sample-button-container" style={{ marginTop: 20 }} data-testid="demo-solve-affordance">
             <button
       ...
       <style>{`
         ...
         .astro-upload-zone:hover, .astro-upload-zone.dragging {
          ...
          .upload-icon { margin-bottom: 16px; opacity: 0.7; }
          ...
          .upload-text strong { display: block; font-size: 1.2em; margin-bottom: 4px; }
          .upload-hint { font-size: 0.8em; opacity: 0.5; margin-top: 12px; }
