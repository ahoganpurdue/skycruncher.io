    ...
    return (
        <div className="sq-pane">
            ...
            {!collapsed && (
                <div className="sq-body">
                    ...
                    >
                        ...
                        <span className="sq-hint">or click to browse · supported: {supportedFormatsLabel()}</span>
                    </div>
            ...
            <style>{`
                ...
                .sq-body { padding: 16px; display: flex; flex-direction: column; gap: 14px; }
                .sq-drop { border: 2px dashed rgba(255,255,255,0.2); border-radius: 10px; padding: 22px; text-align: center;
