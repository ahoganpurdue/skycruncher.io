<!-- REFERENCE · category: reference · tags: Infra · perf measurements; revise on hot-path changes · owner: ahogan -->
# Performance Notes — DSLR expedition, revised targets, the serialization wall

**Living doc (owner-requested 2026-07-06).** Numbers marked **[M]**easured or **[P]**redicted. Companion: `docs/archive/SEESTAR_ROBUSTNESS.md` §5 (original FITS profile), ROADMAP GPU strategy.

## 1. The serialization wall — where data movement actually costs us

Audit of every major copy/encode boundary in the hot paths:
...
| D7 | Rust spherical star-cap + observer plumbing (proposals ready, owner review pending) | unlocks the ultra-wide strategy at bounded cost | B |
...
| Monsters ≥2 GB | headless only, streamed **[M]** | 🚫 browser | in-scope |
...
## 4. D5 outcome + the ultra-wide physics finding (2026-07-06)
...
## 5. Desktop production build — first artifacts (2026-07-06)
